...
class InvoicePrintRenderer {
  ...
  static generateInvoiceHTML(invoice: Invoice) {
    try {
      ...
      const primaryColor = colorMap[design.color as keyof typeof colorMap] || colorMap.blue;
      ...
      const fontFamily = fontMap[design.font as keyof typeof fontMap] || fontMap.inter;
      
      // Calculate total amount
      const totalAmount = invoice.invoice_items?.reduce((sum, item) => sum + Number(item.amount), 0) || 0;
        ...
        <div class="invoice-container">
          ...
          <div class="table-container">
            <table>
              ...
              <tbody>
                ${invoice.invoice_items ? invoice.invoice_items.map(item => `
                <tr>
